...
export const OrderCotroller_GetByUserId = (userId: number, pageNumber: number, pageSize: number, sortBy: string, sortAsc: boolean) => `/orders/${userId}?pageNumber=${pageNumber}&pageSize=${pageSize}&sortBy=${sortBy}&sortAsc=${sortAsc}`
